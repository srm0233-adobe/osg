...
async function fetchNavFragment() {
  ...
  // article at `/magazines/bowhunter/editorial/`) inherit the brand nav that
  // lives one level up in `/magazines/bowhunter/`. Theme-scoped `nav-<theme>` is
  // preferred over the folder default at each level.
